const FooterMenu = () => {
  return (
    <footer className="footer footer-center p-10 bg-[#ffd31a] text-base-content rounded">
      <nav className="flex flex-col lg:flex-row gap-x-10">
        ...
        <h1 className=" text-lg font-semibold">Link Media Sosial</h1>
      </nav>
      <nav>
      ...
      <aside>
        <p>
          Copyright © 2024 - All right reserved by SMAN 20 Jakarta | Developed
          by CJ
        </p>
      </aside>
    </footer>
